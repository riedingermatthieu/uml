...
public class MainFrame
    ...
    JButton myXMLButton = new JButton("XML");
    ...
    private void jbInit() throws Exception {
        ...
        myXMLButton.addActionListener(new ActionListener() {

            @Override
            public void actionPerformed(ActionEvent e) {
                System.out.println(myDrawingPanel.getXML());
            }
        });
    }
